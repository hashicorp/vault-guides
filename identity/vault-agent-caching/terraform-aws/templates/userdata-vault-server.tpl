...
sudo cat << EOF > /home/ubuntu/aws_secrets.sh
vault secrets enable aws
vault write aws/config/root access_key=${aws_access_key_id} secret_key=${aws_secret_access_key}
...
sudo chmod +x /home/ubuntu/aws_secrets.sh

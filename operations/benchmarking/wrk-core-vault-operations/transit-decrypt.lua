...
function request()
  ...
  ciphertext_secret = "vault:v1:xtkcV77x3WSjZfztChg98FRzlXqyKV+y6ibtAeNn7iEg4bgtFvOIU7e3Jbswgh8="
  body = '{"ciphertext": "' .. ciphertext_secret .. '"}'
  -- this test expects there to be an encryption key named "load-test" in a transit engine
  --   available at the following path:
  path = "/v1/transit/decrypt/load-test"

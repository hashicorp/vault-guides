...
# Now edit your Vault config, reference for possible values here: https://developer.hashicorp.com/vault/docs/configuration.
# For example:
-------------------------------------------
vault.hcl:
		storage "file" {

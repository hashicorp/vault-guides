# General
name = "jlundberg-webinar-2018-05-04"
...
bastion_release_version = "0.1.0" # Release version tag (e.g. 0.1.0, 0.1.0-rc1, 0.1.0-beta1, 0.1.0-dev1)
bastion_consul_version  = "1.0.6" # Consul version tag (e.g. 0.9.2 or 0.9.2-ent) - https://releases.hashicorp.com/consul/
bastion_vault_version   = "0.10.0" # Vault version tag (e.g. 0.8.1 or 0.8.1-ent) - https://releases.hashicorp.com/vault/
...
# Consul module
consul_release_version = "0.1.0" # Release version tag (e.g. 0.1.0, 0.1.0-rc1, 0.1.0-beta1, 0.1.0-dev1)
...
# Vault module
vault_release_version = "0.1.0" # Release version tag (e.g. 0.1.0, 0.1.0-rc1, 0.1.0-beta1, 0.1.0-dev1)
vault_version         = "0.10.0" # Vault version tag (e.g. 0.8.1 or 0.8.1-ent) - https://releases.hashicorp.com/vault/

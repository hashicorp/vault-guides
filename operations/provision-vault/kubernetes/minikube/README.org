...
disable Vault [[https://developer.hashicorp.com/vault/docs/concepts/dev-server][dev mode]].
...
and the intent is that it be used solely as the Vault [[https://developer.hashicorp.com/vault/docs/configuration/storage][storage backends]] per HashiCorp's documented best practices for Vault Enterprise
...
[[https://developer.hashicorp.com/vault/tutorials/getting-started/getting-started-deploy#initializing-the-vault][initialized]] and the Operator will need to perform an [[https://developer.hashicorp.com/vault/docs/concepts/seal#unsealing][unseal]] on each
...
for automated
Unsealing<sup>[[https://developer.hashicorp.com/vault/docs/concepts/seal#auto-unseal][1]],[[https://developer.hashicorp.com/vault/docs/enterprise/hsm][2]]</sup> of the cryptographic barrier of the back-end storage however, for the
purpose of this documentation, we will rely on the manual method using Shamir's Secret Sharing<sup>[[https://developer.hashicorp.com/vault/docs/internals/security][1]],[[https://en.wikipedia.org/wiki/Shamir's_Secret_Sharing][2]]</sup>.
...
workflow and is done here only for demo purposes. Please refer to [[https://developer.hashicorp.com/vault/docs/concepts/seal][section of the Vault docs]] for more info.**

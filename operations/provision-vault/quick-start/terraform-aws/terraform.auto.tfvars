name = "jlundberg-webinar-20180504-vault-quick-start"
...
consul_version  = "1.0.6" # Consul Version for runtime install, defaults to 0.9.2
...
vault_version  = "0.10.0" # Vault Version for runtime install, defaults to 0.8.1

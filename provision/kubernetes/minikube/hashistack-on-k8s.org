...
[[https://github.com/hashicorp/hashistack-on-k8s/tree/master/static/examples/consul-vault-on-k8s/consul.yml][consul.yml]]

#+include: "./static/examples/consul-vault-on-k8s/consul.yml" src yaml
...
**** Manifest
[[https://github.com/hashicorp/hashistack-on-k8s/tree/master/static/examples/consul-vault-on-k8s/vault.yml][vault.yml]]

#+include: "./static/examples/consul-vault-on-k8s/vault.yml" src yaml

...
listener "tcp" {
  ...
  tls_key_file       = "/etc/pki/tls/private/vault.key" # https://www.vaultproject.io/docs/configuration/listener/tcp.html#tls_key_file
  tls_cert_file      = "/etc/pki/tls/certs/vault.crt" # https://www.vaultproject.io/docs/configuration/listener/tcp.html#tls_cert_file
  # tls_client_ca_file = "/etc/pki/tls/certs/ca-bundle.crt" # https://www.vaultproject.io/docs/configuration/listener/tcp.html#tls_client_ca_file
}
CONFIG
...
sudo chmod 0755 /etc/pki/tls/private/vault.key /etc/pki/tls/certs/vault.crt
